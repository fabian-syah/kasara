    ...
    function addItem(product) {
        ...
        if (existingItem) {
            ...
            items.value.push({
                ...
                brand: product.product?.brand || product.product?.brandRelation?.name || product.brand || null,
    ...
    function addBundle(bundleItems, totalPrice, description) {
        ...
        items.value.push({
            ...
            bundle_items: bundleItems.map(item => ({
                ...
                brand: item.product?.brand || item.product?.brandRelation?.name || item.brand || null,
