...
<template>
    <div class="space-y-6 max-w-7xl mx-auto pb-16">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <div class="flex items-center gap-2 text-xs font-semibold text-neutral-500 dark:text-neutral-400 mb-1">
                    <span>Menu</span>
                    <span>/</span>
                    <router-link to="/balancing" class="hover:text-primary-600 transition-colors">Balancing</router-link>
                    <span>/</span>
                    <span class="text-neutral-900 dark:text-neutral-100 font-bold">History Balancing</span>
                </div>
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 text-white flex items-center justify-center shadow-lg shadow-emerald-500/20">
                        <Scale :size="22" />
                    </div>
                    <div>
            ...
            <div class="flex flex-wrap items-center gap-2">
                <!-- Month Navigator -->
                <div v-if="dateFilterMode === 'month'" class="flex items-center bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl shadow-sm p-1">
                    <button
                        @click="prevMonth"
                    ...
                    <input
                        ...
                        class="bg-transparent border-none text-sm font-semibold text-neutral-900 dark:text-white focus:outline-none focus:ring-0 px-2 cursor-pointer"
                    />
                ...
                <button
                    ...
                    :disabled="loading"
                    title="Refresh Data"
                    class="p-2.5 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl text-neutral-600 dark:text-neutral-300 hover:text-neutral-900 dark:hover:text-white hover:bg-neutral-50 dark:hover:bg-neutral-800 shadow-sm transition-colors cursor-pointer"
                >
                ...
                <button
                    ...
                    class="flex items-center gap-2 px-3.5 py-2.5 bg-neutral-900 hover:bg-neutral-800 dark:bg-white dark:hover:bg-neutral-100 text-white dark:text-neutral-900 font-semibold text-xs rounded-xl shadow-sm transition-colors disabled:opacity-50 cursor-pointer"
                >
                    <Download :size="15" />
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <!-- 1. Total Omset Minus -->
            <div class="relative overflow-hidden rounded-2xl p-5 border bg-gradient-to-br from-rose-50/80 via-white to-red-50/30 dark:from-rose-950/20 dark:via-neutral-900 dark:to-neutral-900 border-rose-200/80 dark:border-rose-900/40 shadow-sm">
                ...
                <div class="text-2xl lg:text-3xl font-black text-rose-600 dark:text-rose-400 tracking-tight mb-1">
            ...
            <!-- 2. Total Omset Plus -->
            <div class="relative overflow-hidden rounded-2xl p-5 border bg-gradient-to-br from-emerald-50/80 via-white to-teal-50/30 dark:from-emerald-950/20 dark:via-neutral-900 dark:to-neutral-900 border-emerald-200/80 dark:border-emerald-900/40 shadow-sm">
                <div class="flex items-center justify-between mb-2">
                ...
                <div class="text-2xl lg:text-3xl font-black text-emerald-600 dark:text-emerald-400 tracking-tight mb-1">
            ...
            <div class="relative overflow-hidden rounded-2xl p-5 border bg-gradient-to-br from-indigo-50/80 via-white to-violet-50/30 dark:from-indigo-950/20 dark:via-neutral-900 dark:to-neutral-900 border-indigo-200/80 dark:border-indigo-900/40 shadow-sm">
                <div class="flex items-center justify-between mb-2">
                ...
                <div class="text-2xl lg:text-3xl font-black text-indigo-600 dark:text-indigo-400 tracking-tight mb-1">
        ...
        <!-- FILTER BAR -->
        <div class="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-4 shadow-sm space-y-4">
            <div class="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3">
                <!-- Left: Mode Switcher & Date Controls -->
                <div class="flex flex-wrap items-center gap-2.5">
                    <!-- Date Mode Tabs -->
                    <div class="flex p-1 bg-neutral-100 dark:bg-neutral-800/60 rounded-xl border border-neutral-200/60 dark:border-neutral-700/40 text-xs font-semibold">
                        <button
                            @click="dateFilterMode = 'month'"
                            class="px-3 py-1.5 rounded-lg transition-all cursor-pointer"
                            :class="dateFilterMode === 'month'
                                ? 'bg-white dark:bg-neutral-700 text-neutral-900 dark:text-white shadow-sm font-bold'
                    ...
                    <template v-if="dateFilterMode === 'range'">
                        <div class="flex items-center gap-1.5">
                            <input
                                type="date"
                                v-model="startDate"
                                class="px-3 py-1.5 text-xs rounded-xl border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800 text-neutral-900 dark:text-white focus:ring-2 focus:ring-primary-500"
                            />
                            ...
                            <button
                                @click="fetchHistory"
                                class="px-3 py-1.5 bg-primary-600 hover:bg-primary-700 text-white rounded-xl text-xs font-semibold shadow-sm transition-colors cursor-pointer"
                            >
                                Terapkan
                            </button>
                        </div>
                    ...
                    <span v-if="dateFilterMode === 'month'" class="text-xs font-medium text-neutral-500 dark:text-neutral-400 px-2 py-1 bg-neutral-50 dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700">
                        Periode: <strong class="text-neutral-900 dark:text-white">{{ monthNameFormatted }}</strong>
                    </span>
                </div>

                <!-- Right: Active filters summary & reset -->
                <button
                    v-if="selectedBranch !== 'all' || selectedCs !== 'all' || searchQuery || dateFilterMode !== 'month'"
                    @click="resetAllFilters"
                    class="flex items-center gap-1.5 text-xs font-semibold text-rose-600 dark:text-rose-400 hover:underline cursor-pointer self-end lg:self-center"
                >
                    <RotateCcw :size="13" />
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 pt-2 border-t border-neutral-100 dark:border-neutral-800/60">
                <!-- Filter Cabang -->
                <div class="relative">
                    <label class="block text-[11px] font-bold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider mb-1">
                        Cabang
                    </label>
                    <div class="relative">
                        <select
                            v-model="selectedBranch"
                            class="w-full appearance-none px-3 py-2 pr-8 text-xs font-medium rounded-xl border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800 text-neutral-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:outline-none cursor-pointer"
                        >
                ...
                <div class="relative">
                    ...
                    <div class="relative">
                        ...
                        >
                            ...
                            <option v-for="cs in csUsers" :key="cs.id" :value="cs.id">
                                {{ cs.name }}
                            </option>
                        </select>
                        <ChevronDown :size="14" class="absolute right-2.5 top-1/2 -translate-y-1/2 text-neutral-400 pointer-events-none" />
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="relative">
                        <input
                            ...
                            class="w-full pl-9 pr-4 py-2 text-xs font-medium rounded-xl border border-neutral-200 dark:border-neutral-700 bg-neutral-50 dark:bg-neutral-800 text-neutral-900 dark:text-white placeholder-neutral-400 focus:ring-2 focus:ring-primary-500 focus:outline-none"
                        />
        ...
        <div class="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl shadow-sm overflow-hidden">
            ...
            <div v-else class="overflow-x-auto">
                <table class="w-full text-left text-xs text-neutral-600 dark:text-neutral-300">
                    <thead class="bg-neutral-50/80 dark:bg-neutral-800/50 text-[11px] font-bold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider border-b border-neutral-200 dark:border-neutral-800">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3.5 min-w-[180px]">Keterangan</th>
                            ...
                            <th scope="col" class="px-4 py-3.5 text-right whitespace-nowrap">Salah Metode Pembayaran</th>
                            <th scope="col" class="px-4 py-3.5 text-center whitespace-nowrap">Foto-foto</th>
                        ...
                        >
                            ...
                            <td class="px-4 py-3.5 whitespace-nowrap">
                                <span
                                    ...
                                    class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[11px] font-bold bg-violet-50 text-violet-700 dark:bg-violet-950/40 dark:text-violet-300 border border-violet-200 dark:border-violet-800/40"
                                >
                                ...
                                <span
                                    ...
                                    class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[11px] font-bold bg-amber-50 text-amber-700 dark:bg-amber-950/40 dark:text-amber-300 border border-amber-200 dark:border-amber-800/40"
                                >
                            ...
                            <!-- 4. Tanggal Omset -->
                            <td class="px-4 py-3.5 whitespace-nowrap">
                                <div class="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md bg-neutral-100 dark:bg-neutral-800 font-semibold text-neutral-800 dark:text-neutral-200 text-[11px]">
                            ...
                            <td class="px-4 py-3.5 text-center whitespace-nowrap">
                                <div v-if="row.photos && row.photos.length > 0" class="flex items-center justify-center -space-x-2">
                                    <button
                                        ...
                                        class="relative w-8 h-8 rounded-lg overflow-hidden border-2 border-white dark:border-neutral-900 shadow-sm hover:scale-110 hover:z-10 transition-transform cursor-pointer"
                                        :title="photo.label"
                                    >
                                    ...
                                    <button
                                        ...
                                        class="w-8 h-8 rounded-lg bg-neutral-800 text-white text-[10px] font-bold flex items-center justify-center border-2 border-white dark:border-neutral-900 shadow-sm cursor-pointer"
                                    >
                                        +{{ row.photos.length - 3 }}
                                    </button>
                                </div>
                            ...
                            <td class="px-4 py-3.5 text-center whitespace-nowrap">
                                <button
                                    ...
                                    class="p-1.5 text-neutral-500 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-lg transition-colors cursor-pointer"
                                    title="Lihat Detail"
                                >
                                    <Eye :size="16" />
                                </button>
        ...
        >
            <div class="relative max-w-4xl w-full max-h-[90vh] flex flex-col items-center">
                ...
                <div class="w-full flex items-center justify-between text-white mb-3 px-2">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xs text-neutral-400">
                            ({{ currentPhotoIndex + 1 }} dari {{ currentPhotos.length }})
                        </span>
                    </div>
                    <div class="flex items-center gap-2">
                        <a
                ...
                <!-- Main Image Preview -->
                <div class="relative flex items-center justify-center w-full max-h-[70vh] overflow-hidden rounded-2xl bg-neutral-950">
                    <img
                    ...
                    <button
                        ...
                        @click="prevPhoto"
                        class="absolute left-3 top-1/2 -translate-y-1/2 p-2.5 rounded-full bg-black/50 hover:bg-black/80 text-white transition-colors cursor-pointer"
                    >
                        <ChevronLeft :size="22" />
                    </button>
                    <button
                        v-if="currentPhotos.length > 1"
                        @click="nextPhoto"
                        class="absolute right-3 top-1/2 -translate-y-1/2 p-2.5 rounded-full bg-black/50 hover:bg-black/80 text-white transition-colors cursor-pointer"
                    >
                ...
                <!-- Bottom Thumbnails -->
                <div v-if="currentPhotos.length > 1" class="flex items-center gap-2 mt-4 overflow-x-auto max-w-full p-2">
                    <button
                        v-for="(ph, idx) in currentPhotos"
                        :key="idx"
                        @click="currentPhotoIndex = idx"
                        class="w-14 h-14 rounded-xl overflow-hidden border-2 transition-all cursor-pointer flex-shrink-0"
                        :class="currentPhotoIndex === idx ? 'border-primary-500 scale-105' : 'border-white/20 opacity-60 hover:opacity-100'"
                    >
        ...
        >
            <div class="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                <!-- Modal Header -->
                <div class="px-6 py-4 border-b border-neutral-200 dark:border-neutral-800 flex items-center justify-between sticky top-0 bg-white/90 dark:bg-neutral-900/90 backdrop-blur-md z-10">
                    <div class="flex items-center gap-2.5">
                        <div class="p-2 rounded-xl bg-primary-50 dark:bg-primary-950/40 text-primary-600 dark:text-primary-400">
                            <Scale :size="18" />
                        </div>
                        <div>
                            ...
                            <p class="text-xs text-neutral-400 font-mono">{{ selectedItem.receipt_id }}</p>
                        </div>
                    </div>
                    <button
                ...
                <div class="p-6 space-y-5 text-xs">
                    ...
                    <div class="grid grid-cols-2 gap-4 p-4 rounded-xl bg-neutral-50 dark:bg-neutral-800/50 border border-neutral-200/80 dark:border-neutral-700/50">
                        <div>
                            <span class="text-neutral-400 block mb-0.5 font-medium">Tanggal Input</span>
                            <span class="font-bold text-neutral-900 dark:text-white">{{ formatDateTime(selectedItem.tanggal) }}</span>
                        </div>
                        <div>
                            <span class="text-neutral-400 block mb-0.5 font-medium">Tanggal Omset</span>
                            <span class="font-bold text-neutral-900 dark:text-white">{{ formatDate(selectedItem.tanggal_omset) }}</span>
                        </div>
                        <div>
                            <span class="text-neutral-400 block mb-0.5 font-medium">Cabang</span>
                            <span class="font-bold text-neutral-900 dark:text-white">{{ selectedItem.cabang }}</span>
                        </div>
                        <div>
                            <span class="text-neutral-400 block mb-0.5 font-medium">Nama CS</span>
                            <span class="font-bold text-neutral-900 dark:text-white">{{ selectedItem.nama_cs }}</span>
                        </div>
                        <div v-if="selectedItem.customer_name">
                            <span class="text-neutral-400 block mb-0.5 font-medium">Nama Customer</span>
                        ...
                        <div v-if="selectedItem.customer_phone">
                            <span class="text-neutral-400 block mb-0.5 font-medium">Kontak Customer</span>
                            <span class="font-bold text-neutral-900 dark:text-white">{{ selectedItem.customer_phone }}</span>
                        </div>
                        <div>
                            <span class="text-neutral-400 block mb-0.5 font-medium">Dibuat Oleh</span>
                            <span class="font-bold text-neutral-900 dark:text-white">{{ selectedItem.created_by }}</span>
                        </div>
                        <div>
                            <span class="text-neutral-400 block mb-0.5 font-medium">Status</span>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <div class="p-3 rounded-xl border border-rose-200 dark:border-rose-900/40 bg-rose-50/50 dark:bg-rose-950/20 text-right">
                                <span class="text-[10px] font-bold text-rose-500 block uppercase">Omset Minus</span>
                                <span class="font-black text-sm text-rose-600 dark:text-rose-400">
                                    {{ selectedItem.nominal_omset_minus > 0 ? '-' + formatCurrency(selectedItem.nominal_omset_minus) : 'Rp 0' }}
                                </span>
                            </div>
                            <div class="p-3 rounded-xl border border-emerald-200 dark:border-emerald-900/40 bg-emerald-50/50 dark:bg-emerald-950/20 text-right">
                            ...
                            <div class="p-3 rounded-xl border border-indigo-200 dark:border-indigo-900/40 bg-indigo-50/50 dark:bg-indigo-950/20 text-right">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="p-3.5 rounded-xl bg-neutral-50 dark:bg-neutral-800/60 border border-neutral-200 dark:border-neutral-700 text-neutral-800 dark:text-neutral-200 leading-relaxed whitespace-pre-wrap">
                ...
                <!-- Modal Footer -->
                <div class="px-6 py-3 border-t border-neutral-200 dark:border-neutral-800 flex justify-end">
                    <button
                        @click="showDetailModal = false"
                        class="px-4 py-2 bg-neutral-100 hover:bg-neutral-200 dark:bg-neutral-800 dark:hover:bg-neutral-700 text-neutral-700 dark:text-neutral-200 font-semibold rounded-xl transition-colors cursor-pointer"
                    >
                        Tutup
                    </button>
                </div>
