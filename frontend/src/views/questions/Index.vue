...
const categories = [
    ...
    { value: 'pelunasan_dp', label: 'Pelunasan DP' },
    ...
    { value: 'tukar_unit', label: 'Barang Masuk Tukar Unit' },
    { value: 'balancing_penjualan_terlewat', label: 'Balancing Penjualan Terlewat' },
    { value: 'balancing_metode_pembayaran', label: 'Balancing Metode Pembayaran' },
