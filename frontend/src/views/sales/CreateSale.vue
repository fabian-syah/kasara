...
<template>
            ...
            <div class="flex-[2] space-y-8 min-w-0">
                <div
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-bold text-text-secondary uppercase tracking-widest mb-3">
    ...
    <Teleport to="body">
        <div v-if="showSuccessModal" class="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div
                ...
                <button v-if="lastTransaction?.customer_phone" @click="showReceiptModal = true; shouldAutoSendWA = true"
    ...
    <PinModal :show="showInitialPinSetup" mode="setup" title="Setup PIN Transaksi" @close="showInitialPinSetup = false"
        @success="showInitialPinSetup = false" />
