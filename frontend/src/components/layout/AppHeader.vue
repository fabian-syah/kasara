...
<template>
    <header
        class="sticky top-0 z-[50] flex items-center justify-between h-[64px] lg:h-[72px] px-4 lg:px-8 bg-white dark:bg-[#0d0d0d] border-b border-neutral-200/50 dark:border-neutral-800/60 transition-colors duration-300 shadow-sm">
