                ...
                <div
                    ...
                    <div class="p-4 bg-white dark:bg-surface-800 border-t border-gray-100 dark:border-surface-700 flex gap-3 items-center print:hidden shrink-0">
                        ...
                        <button @click="printReceipt"
                            class="px-4 py-3 text-sm font-bold text-white bg-gray-900 dark:bg-surface-600 dark:text-white rounded-2xl hover:bg-gray-800 dark:hover:bg-surface-500 transition-colors flex items-center justify-center gap-2 shadow-lg active:scale-95 border border-gray-900 dark:border-surface-500">
                            <Printer :size="18" />
                            Cetak
                        </button>
                    </div>
