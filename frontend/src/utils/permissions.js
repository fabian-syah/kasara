...
export const ROLE_MENUS = {
    ...
    [ROLES.AUDIT]: ['dashboard', 'inventory', 'inventory_main', 'inventory_opname', 'download_center', 'inventory_monitoring_hub', 'audit', 'audit_sales_report', 'audit_profit_uc', 'audit_stock_in_uc', 'audit_stock_out_uc', 'audit_pin_resets', 'audit_photo_approvals', 'master_data_group', 'users', 'support_group', 'track', 'sales_check', 'sales_ranking', 'analysis_group', 'stock_analysis'],
