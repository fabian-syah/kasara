...
export const ROLE_MENUS = {
    ...
    [ROLES.LEADER]: ['dashboard', 'monitoring_group', 'distributor_monitoring', 'online_monitoring', 'warehouse_monitoring', 'stock_summary', 'support_group', 'track', 'balancing_group', 'balancing_history'],
