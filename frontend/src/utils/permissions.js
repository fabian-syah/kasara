...
export const ROLE_MENUS = {
    ...
    [ROLES.ANALIST]: ['dashboard', 'inventory', 'inventory_main', 'inventory_opname', 'inventory_monitoring_hub', 'audit', 'audit_sales_report', 'audit_profit_uc', 'audit_stock_in_uc', 'audit_stock_out_uc', 'audit_pin_resets', 'audit_photo_approvals', 'audit_cabang', 'audit_sales_sub', 'audit_inventory_sub', 'audit_analysis_sub', 'monitoring_group', 'distributor_monitoring', 'online_monitoring', 'warehouse_monitoring', 'stock_summary', 'reports', 'report_sales', 'report_ranking', 'report_brand', 'report_type', 'stock_in_history', 'stock_out_history', 'support_group', 'track'],
    [ROLES.ADMIN_PRODUK]: ['dashboard', 'master_data_group', 'brands', 'types', 'prices', 'track'],
    [ROLES.AUDIT]: ['dashboard', 'inventory', 'inventory_main', 'inventory_opname', 'inventory_monitoring_hub', 'audit', 'audit_sales_report', 'audit_profit_uc', 'audit_stock_in_uc', 'audit_stock_out_uc', 'audit_pin_resets', 'audit_photo_approvals', 'audit_cabang', 'audit_sales_sub', 'audit_inventory_sub', 'audit_analysis_sub', 'master_data_group', 'users'],
