...
export const ROLE_MENUS = {
    ...
    [ROLES.AUDIT]: ['dashboard', 'audit_cabang', 'audit', 'audit_pin_resets', 'users', 'inventory', 'inventory_monitoring_hub', 'track', 'track_main'],
    ...
    [ROLES.DISTRIBUTOR]: ['dashboard', 'inventory', 'inventory_main', 'inventory_monitoring_hub', 'track', 'track_main'],
    [ROLES.DISTRIBUTION]: ['dashboard', 'inventory', 'inventory_main', 'inventory_monitoring_hub', 'track', 'track_main'],
    [ROLES.SALES]: ['dashboard', 'sales_create', 'sales_check', 'sales_check_main', 'sales_ranking', 'inventory', 'inventory_main', 'inventory_monitoring_hub', 'track', 'track_main', 'sales_imei_history'],
    [ROLES.GUDANG]: ['dashboard', 'inventory', 'inventory_main', 'inventory_monitoring_hub', 'retur_items', 'track', 'track_main'],
    [ROLES.INVENTORY_KASIR]: ['dashboard', 'pos', 'transactions', 'track', 'track_main'],
    [ROLES.TOKO_ONLINE]: ['dashboard', 'online_sales_group', 'inventory', 'inventory_main', 'inventory_monitoring_hub', 'reports', 'track', 'track_main']
}
