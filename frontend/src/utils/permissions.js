...
export const ROLE_MENUS = {
    [ROLES.SUPER_ADMIN]: ['dashboard', 'online_sales_group', 'online_sales', 'shopee_history', 'online_scan', 'online_analysis', 'pos', 'inventory', 'master_data_group', 'monitoring_group', 'support_group', 'inventory_main', 'inventory_opname', 'stock_analysis', 'download_center', 'inventory_monitoring_hub', 'retur_items', 'users', 'warehouses', 'online_shops', 'brands', 'types', 'prices', 'categories', 'distributors', 'payment_methods', 'audit_sales', 'audit', 'audit_cabang', 'audit_sales_sub', 'audit_inventory_sub', 'audit_analysis_sub', 'audit_sales_report', 'audit_profit_uc', 'audit_stock_in_uc', 'audit_stock_out_uc', 'audit_photo_approvals', 'reports', 'report_sales', 'report_ranking', 'report_brand', 'report_type', 'stock_in_history', 'stock_out_history', 'audit_pin_resets', 'settings', 'distributor_monitoring', 'online_monitoring', 'warehouse_monitoring', 'stock_summary', 'channels', 'branches', 'questions', 'track', 'sales_check', 'sales_check_main', 'sales_ranking'],
    [ROLES.ANALIST]: ['dashboard', 'inventory', 'inventory_main', 'inventory_opname', 'stock_analysis', 'download_center', 'reports', 'report_ranking', 'sales_check', 'sales_ranking'],
    [ROLES.ADMIN_PRODUK]: ['dashboard', 'master_data_group', 'brands', 'types', 'prices', 'support_group', 'track'],
    [ROLES.AUDIT]: ['dashboard', 'inventory', 'inventory_main', 'inventory_opname', 'stock_analysis', 'download_center', 'inventory_monitoring_hub', 'audit', 'audit_sales_report', 'audit_profit_uc', 'audit_stock_in_uc', 'audit_stock_out_uc', 'audit_pin_resets', 'audit_photo_approvals', 'audit_cabang', 'audit_sales_sub', 'audit_inventory_sub', 'audit_analysis_sub', 'master_data_group', 'users', 'support_group', 'track', 'sales_check', 'sales_ranking'],
    [ROLES.SECURITY]: ['dashboard', 'track'],
