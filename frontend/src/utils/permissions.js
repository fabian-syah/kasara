...
>>>>>>> 32e882942eeee67590a48ceeaa345e3d49462397
    [ROLES.ADMIN_PRODUK]: ['dashboard', 'brands', 'types', 'prices', 'track', 'track_main'],
    [ROLES.AUDIT]: ['dashboard', 'audit_cabang', 'audit_sales_sub', 'audit_inventory_sub', 'audit_analysis_sub', 'audit', 'audit_sales_report', 'audit_profit_uc', 'audit_stock_in_uc', 'audit_stock_out_uc', 'audit_pin_resets', 'users', 'inventory', 'inventory_main', 'inventory_opname', 'inventory_monitoring_hub', 'track', 'track_main', 'track_main', 'sales_imei_history'],
    ...
    [ROLES.DISTRIBUTOR]: ['dashboard', 'inventory', 'inventory_main', 'inventory_opname', 'inventory_monitoring_hub', 'track', 'track_main', 'track_main', 'sales_imei_history'],
    [ROLES.DISTRIBUTION]: ['dashboard', 'inventory', 'inventory_main', 'inventory_opname', 'inventory_monitoring_hub', 'track', 'track_main', 'track_main', 'sales_imei_history'],
    [ROLES.SALES]: ['dashboard', 'sales_create', 'sales_check', 'sales_check_main', 'sales_ranking', 'inventory', 'inventory_main', 'inventory_opname', 'inventory_monitoring_hub', 'track', 'track_main', 'track_main', 'sales_imei_history'],
    [ROLES.GUDANG]: ['dashboard', 'inventory', 'inventory_main', 'inventory_opname', 'inventory_monitoring_hub', 'retur_items', 'track', 'track_main', 'track_main', 'sales_imei_history'],
    [ROLES.INVENTORY_KASIR]: ['dashboard', 'pos', 'transactions', 'track', 'track_main'],
    [ROLES.TOKO_ONLINE]: ['dashboard', 'online_sales_group', 'online_sales', 'shopee_history', 'inventory', 'inventory_main', 'inventory_opname', 'inventory_monitoring_hub', 'reports', 'report_sales', 'track', 'track_main', 'track_main', 'sales_imei_history']
}
