...
class StockMutationExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithTitle
{
    ...
    public function headings(): array
    {
        return [
            ...
            'Stok Awal',
            'Total Masuk',
            'Masuk TT', 'Masuk TU', 'Masuk DW', 'Masuk RF', 'Masuk AB',
            'Terjual',
            'Total Keluar',
            'Keluar TT', 'Keluar TU', 'Keluar DW',
            'Stok Akhir'
        ];
    }
    ...
    public function map($row): array
    {
        return [
            ...
            $row['initial'],
            $row['in'],
            $row['in_tt'], $row['in_tu'], $row['in_dw'], $row['in_rf'], $row['in_ab'],
            $row['sold'],
            $row['out'],
            $row['out_tt'], $row['out_tu'], $row['out_dw'],
            $row['final']
        ];
    }
}
