...
class InventoryAccountController extends Controller
{
    ...
    public function getMyInventoryUsers(Request $request)
    {
        ...
        $inventoryUsers = $query->select('id', 'name', 'full_name', 'username', 'code_id', 'created_by', 'photo', 'photo_inventory', 'branch_id', 'warehouse_id', 'online_shop_id', 'pin_enabled', 'password', 'password_changed_at')
            ->get();
