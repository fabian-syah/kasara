...
<head>
    ...
    <style>
        ...
        .garansi-title {
            ...
            color: #1e1b4b;
            margin-bottom: 6px;
            border-bottom: 1px solid #cbd5e140;
            padding-bottom: 4px;
        }
...
<body>
    ...
    <table class="item-table">
        ...
        <tbody>
            @foreach($transaction->items as $item)
                <tr>
                    <td style="text-align: center; font-weight: 800; color: #1e1b4b;">1</td>
                    <td>
            ...
            @foreach($transaction->nonHpItems as $item)
                <tr>
                    <td style="text-align: center; font-weight: 800; color: #1e1b4b;">{{ $item->quantity }}</td>
                    <td>
        ...
        <div class="payment-container">
            ...
            @if($transaction->global_discount_value > 0)
                <div class="payment-row">
                    ...
                    <span class="payment-value" style="color: #059669;">-Rp {{ number_format($total_discount, 0, ',', '.') }}</span>
                </div>
            @endif
    ...
    <div class="garansi-box">
        ...
        <ul class="garansi-list">
            <li style="font-weight: 800; color: #1e1b4b;">Garansi 1 Bulan (Nota Dan Segel Jangan Hilang)</li>
